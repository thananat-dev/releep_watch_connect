...
/// 3.5.2.11 通知提醒类型
typedef SWIFT_ENUM(uint16_t, YCDeviceInfoPushType, closed) {
  YCDeviceInfoPushTypeTelegram = 1,
  YCDeviceInfoPushTypeSnapchat = 2,
  YCDeviceInfoPushTypeLine = 4,
  YCDeviceInfoPushTypeSkype = 8,
  YCDeviceInfoPushTypeInstagram = 16,
  YCDeviceInfoPushTypeLinkedIn = 32,
  YCDeviceInfoPushTypeWhatsAPP = 64,
  YCDeviceInfoPushTypeMessenger = 128,
  YCDeviceInfoPushTypeTwitter = 256,
  YCDeviceInfoPushTypeFacebook = 512,
  YCDeviceInfoPushTypeWeiBo = 1024,
  YCDeviceInfoPushTypeQq = 2048,
  YCDeviceInfoPushTypeWeChat = 4096,
  YCDeviceInfoPushTypeEmail = 8192,
  YCDeviceInfoPushTypeSms = 16384,
  YCDeviceInfoPushTypeCall = 32768,
};
...
/// 下载表盘进度信息
SWIFT_CLASS("_TtC12YCProductSDK31YCWatchFaceDownloadProgressInfo")
@interface YCWatchFaceDownloadProgressInfo : NSObject
/// 进度
@property (nonatomic, readonly) float progress;
/// 已下载数据大小
